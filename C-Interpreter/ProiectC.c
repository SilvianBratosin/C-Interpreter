...
)
{
	...
	switch(p->type) 
	{
		case typeCon: sprintf (word, "c(%d)", p->con.val); break;
		...
		case typeOper:
			switch(p->opr.oper)
			{
				...
				case IF: 		if(p->opr.oper==IF) s = "if"; break;
				...
				case '<': 		s = "[<]"; break;
				case '>': 		s = "[>]"; break;
				case PREINC: 	s="++(pre)"; break;
				case PREDEC: 	s="--(pre)"; break;
				case POSTINC: 	s="(post)++"; break;
				case POSTDEC: 	s="(post)--"; break;
				case GE: 		s = "[>=]"; break;
				case LE: 		s = "[<=]"; break;
				case NE: 		s = "[!=]"; break;
				case EQ: 		s = "[==]"; break;
